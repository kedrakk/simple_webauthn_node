/*
  ...
  - You are about to alter the column `public_key` on the `passkeys` table. The data in that column could be lost. The data in that column will be cast from `String` to `Binary`.
